...
namespace OpenCraft
{
    internal class Game: GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            GameWorld = new World(new Shader("Default.vert", "Default.frag"));
        ...
        protected override void OnRenderFrame(FrameEventArgs args)
        {
            ...
            if (fpsTime >= 1.0)
            {
                ...
                Title = $"OpenCraft v0.1b | FPS: {fps}";
            }

            GL.ClearColor(0.53f, 0.81f, 0.92f, 1.0f);
            GL.Clear(ClearBufferMask.ColorBufferBit | ClearBufferMask.DepthBufferBit);

            Background.DrawBackground(MainCamera.pitch);
        ...
        protected override void OnUpdateFrame(FrameEventArgs args)
        {
            ...
            if (_raycaster.RaycastBlock(origin, dir, reach, out var hit, out var normal))
            {
                if (MouseState.IsButtonPressed(MouseButton.Left))
                    if (mouseCaptured) _raycaster.SetBlockWorld(hit, 0);
