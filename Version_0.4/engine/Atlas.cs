...
public sealed class SimpleGridAtlas
{
    ...
    public void Add(string path, int id)
    {
        ...
        float u0 = (x0) * invW + epsU;
        float v0 = (y0) * invH + epsV;
        float u1 = (x0 + TileWidth) * invW - epsU;
        float v1 = (y0 + TileHeight) * invH - epsV;

        _regions[id] = new Region(u0, v0, u1, v1);
    }
    ...
    public int UploadToGpu(
        ...
        TextureMinFilter minFilter = TextureMinFilter.Nearest, //.Linear
